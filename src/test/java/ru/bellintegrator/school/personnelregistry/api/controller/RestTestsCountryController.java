...
public class RestTestsCountryController {
    ...
    public void getByIdTest() throws URISyntaxException {
        String url = "http://localhost:" + port + "/api/countries";
        URI uri = new URI(url);
        ...
        assertThat(listCountries.get(0).get("id"), is(1));
        assertThat(listCountries.get(0).get("code"), is(643));
        assertThat(listCountries.get(0).get("name"), is("Российская Федерация"));
    }
}
