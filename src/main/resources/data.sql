...
INSERT INTO office(id, name, address, is_active, organization_id)
  VALUES
  (1, 'Институт энергетики и транспортных систем', 'г.Саратов', true, 1),
  (2, 'Институт электронной техники и машиностроения', 'г.Саратов', true, 1),
  (3, 'Институт прикладных информационных технологий и коммуникаций', 'г.Саратов', true, 1),
  (4, 'Физико-технический институт', 'г.Саратов', true, 1),
  (5, 'Институт урбанистики, архитектуры и строительства', 'г.Саратов', true, 1),
  (6, 'Институт социального и производственного менеджмента', 'г.Саратов', true, 1);
